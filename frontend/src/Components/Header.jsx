                    ...
                    <nav>
                        <div className="flex items-center">
                            ...
                            <button onClick={() => toggleDarkMode()}
                                ...
                                <svg className="fill-violet-700 block hidden dark:block" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
                                </svg>
                                <svg className="fill-yellow-500 dark:hidden" fill="currentColor" viewBox="0 0 20 20">
